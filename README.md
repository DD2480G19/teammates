...
| 3 |  **Function**: `FeedbackRankRecipientsResponseDetails::getUpdateOptionsForRankRecipientQuestions` <br> **Test cases added:**  <br>Branch: [coverage improvement, function 3](https://github.com/DD2480G19/teammates/tree/44-coverage-improvement-function-3/) <br> - [New test 1]() <br> - [New test 2]() <br> - [New test 3]() <br> - [New test 4]() <br> **Show patch (from master):** `git diff origin/44-coverage-improvement-function-3` <br> Report of old coverage: [link](improved_coverage/function3/oldCoverage.png) <br> Report of new coverage: [link](improved_coverage/function3/newCoverage.png) |
